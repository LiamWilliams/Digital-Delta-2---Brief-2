...
//@interface WorkingFilesObject : NSObject
//@end

@interface WorkingFilesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WorkingFilesObject class]])
		{
			for (NSString *key in [[(WorkingFilesObject*)o modules] allKeys])
			{
