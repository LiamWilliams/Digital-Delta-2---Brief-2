...
// in simulator we redefine to format for WorkingFiles Developer console
...
{\
	NSString * exceptionName = [@"org.workingfiles." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.workingfiles";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIWorkingFilesNativeItemNone = -1, 
	UIWorkingFilesNativeItemSpinner = -2,
	UIWorkingFilesNativeItemProgressBar = -3,
	
	UIWorkingFilesNativeItemSlider = -4,
	UIWorkingFilesNativeItemSwitch = -5,
	UIWorkingFilesNativeItemMultiButton = -6,
	UIWorkingFilesNativeItemSegmented = -7,
	
	UIWorkingFilesNativeItemTextView = -8,
	UIWorkingFilesNativeItemTextField = -9,
	UIWorkingFilesNativeItemSearchBar = -10,
	
	UIWorkingFilesNativeItemPicker = -11,
	UIWorkingFilesNativeItemDatePicker = -12,
	
	UIWorkingFilesNativeItemInfoLight = -13,
	UIWorkingFilesNativeItemInfoDark = -14,
	
	UIWorkingFilesNativeItemDisclosure = -15,
	
	UIWorkingFilesNativeItemContactAdd = -16
};
